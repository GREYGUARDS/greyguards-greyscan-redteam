            ...
            <div className="pt-4 border-t-2 border-border">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <p className="text-xs font-bold uppercase tracking-wide">Quick Start / Diagnostics</p>
                ...
                <div className="space-y-2">
                  <p className="text-xs font-bold uppercase tracking-wide">Intelligence & Reporting</p>
                  <div className="grid gap-2">
                    <div className="bg-card border-2 border-border p-3 rounded-sm">
                ...
                <div className="space-y-2">
                  <p className="text-xs font-bold uppercase tracking-wide">Strategic Advisory & Training</p>
                  <div className="grid gap-2">
                    <div className="bg-card border-2 border-border p-3 rounded-sm">
                ...
                <div className="space-y-2">
                  <p className="text-xs font-bold uppercase tracking-wide">Active Response & Influence</p>
                  <div className="grid gap-2">
                    <div className="bg-card border-2 border-border p-3 rounded-sm">
                ...
                <div className="space-y-2">
                  <p className="text-xs font-bold uppercase tracking-wide">Advanced Intelligence & Systems</p>
                  <div className="grid gap-2">
                    <div className="bg-card border-2 border-border p-3 rounded-sm">
                ...
                <div className="space-y-2">
                  <p className="text-xs font-bold uppercase tracking-wide">Policy, Institutional & Global</p>
                  <div className="grid gap-2">
                    <div className="bg-card border-2 border-border p-3 rounded-sm">
